export const data = [
  {
    ...
    chat: [
      ...
      },
      {
        ...
        you: {
          message:
            "Coming to my wedding right? I don't think you confirmed.",
          timeStamp: '10:44',
        },
      },
      {
  ...
  },
  {
    ...
    chat: [
      ...
      },
      {
        ...
        you: {
          message:
            'we are. My mouth waters whenever drive thorugh that area',
          timeStamp: '13:14',
        },
      },
      {
        user2: {
          message:
            'haha, I bet. Lets take Tony and Natasha too next time',
          timeStamp: '13:14',
        },
        you: {
